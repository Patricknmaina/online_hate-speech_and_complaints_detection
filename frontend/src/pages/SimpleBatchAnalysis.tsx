    ...
    >
      ...
      >
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2 mt-4">
            ...
            {file && (
              <motion.div 
                className="bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-lg inline-flex items-center gap-2"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
      ...
      {results.length > 0 && !error && (
        ...
        >
          {/* Summary */}
          <motion.div 
            className="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-xl p-6"
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ type: "spring", stiffness: 200 }}
          >
            <h3 className="text-xl font-bold text-green-800 dark:text-green-200 mb-2 flex items-center gap-2">
...
export default SimpleBatchAnalysis;
